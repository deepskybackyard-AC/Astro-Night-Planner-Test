/* Astro Night Planner 1.3.0-test.5 – Testversion */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'test', appVersion:'1.3.0-test.5', release:'1.3.0-test.5', databaseName:'astro-night-planner-test-v1', documentTitle:'Astro Night Planner 1.3.0-test.5'});
