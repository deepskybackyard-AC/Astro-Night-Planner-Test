...
Object.assign(EN_EXACT,{
  'Der Katalogfilter LDN/LBN enthält in dieser Testversion benannte LDN-Dunkelnebel. LBN-Objekte sind noch nicht als eigener Katalog importiert. Größenwerte der LDN-Objekte werden aus der katalogisierten Fläche als äquivalenter Kreis-Durchmesser berechnet und dienen als praktische Filter- und Rahmungshilfe.':'In this test version, the LDN/LBN catalog filter contains named LDN dark nebulae. LBN objects have not yet been imported as a separate catalog. LDN size values are derived from the catalogued area as an equivalent circular diameter and are intended as practical filtering and framing aids.',
