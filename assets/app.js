/* Astro Night Planner 1.1.0-test.41 – Wettervergleich ohne eigene Astro-Wolkenkarte */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'test', appVersion:'1.1.0-test.41', release:'1.1.0-test.41', databaseName:'astro-night-planner-test-v1', documentTitle:'Astro Night Planner 1.1.0-test.41'});
