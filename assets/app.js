...
function cloudMapSnapshotDataUrl(frameIndexOverride=null,width=1400,height=720){
...
function openWeatherComparisonWindow(){
  ...
  const subtitle=ui('Aktuelle Auswahl aus der Planung, steuerbar über den gemeinsamen Regler.','Current selection from the planning view, controlled by the shared slider.');
