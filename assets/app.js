/* Astro Night Planner 1.1.0-test.32 – Astro-Wolkenmodell-Rubrik und Meteoblue-Links */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'test', appVersion:'1.1.0-test.32', release:'1.1.0-test.32', databaseName:'astro-night-planner-test-v1', documentTitle:'Astro Night Planner 1.1.0-test.32'});
...
Object.assign(EN_EXACT,{
  ...
  'Die eingebettete Karte bleibt bewusst einfach. Für gezielte Meteoblue-Ansichten öffne Windanimation oder Wolken/Niederschlag als separaten Meteoblue-Tab.':'The embedded map is kept deliberately simple. For specific Meteoblue views, open wind animation or clouds/precipitation as a separate Meteoblue tab.',
  'Die separaten Meteoblue-Buttons übergeben den aktuellen Planungsstandort. Meteoblue kann trotzdem den zuletzt verwendeten Kartenmodus wiederherstellen.':'The separate Meteoblue buttons pass the current planning location. Meteoblue may still restore the last used map mode.'
});
...
function renderMeteoblue(loc){
  ...
  <section class="card meteoblue-card">
    <details ${mapCollapsed?'':'open'} id="meteoblueMapDetails">
      ...
      <div class="notice" style="margin-top:12px">${ui('Die eingebettete Karte bleibt bewusst einfach. Für gezielte Meteoblue-Ansichten öffne Windanimation oder Wolken/Niederschlag als separaten Meteoblue-Tab.','The embedded map is kept deliberately simple. For specific Meteoblue views, open wind animation or clouds/precipitation as a separate Meteoblue tab.')}<br>${ui('Die separaten Meteoblue-Buttons übergeben den aktuellen Planungsstandort. Meteoblue kann trotzdem den zuletzt verwendeten Kartenmodus wiederherstellen.','The separate Meteoblue buttons pass the current planning location. Meteoblue may still restore the last used map mode.')}</div>
      <div class="meteoblue-actions" style="margin-top:10px">
