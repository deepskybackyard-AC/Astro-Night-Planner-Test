/* Astro Night Planner 1.4.2-test.4 – Testversion */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'test', appVersion:'1.4.2-test.4', release:'1.4.2-test.4', databaseName:'astro-night-planner-test-v1', documentTitle:'Astro Night Planner 1.4.2-test.4'});
...
Object.assign(EN_EXACT,{
  ...
  'Der optionale Local Survey Server 1.1.3 kann lokale HiPS-Dateien ohne Python bereitstellen und alle in der App eingebauten sowie benutzerdefinierte kompatible HiPS-Surveys herunterladen.':'The optional Local Survey Server 1.1.3 can serve local HiPS files without Python and download all surveys built into the app as well as compatible custom HiPS surveys.',
  'Local Survey Server öffnen':'Open Local Survey Server',
  'Local Survey Server nicht erreichbar. Starte ANP-Local-Survey-Server-1.1.3.exe oder aktiviere den Autostart.':'Local Survey Server not reachable. Start ANP-Local-Survey-Server-1.1.3.exe or enable autostart.',
