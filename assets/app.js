/* Astro Night Planner 1.4.2-test.1 – Testversion */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'test', appVersion:'1.4.2-test.1', release:'1.4.2-test.1', databaseName:'astro-night-planner-test-v1', documentTitle:'Astro Night Planner 1.4.2-test.1'});
...
Object.assign(EN_EXACT,{
  ...
  'Der optionale Local Survey Server 1.1 kann lokale HiPS-Dateien ohne Python bereitstellen und bekannte NSNS-HiPS-Surveys vollständig herunterladen.':'The optional Local Survey Server 1.1 can serve local HiPS files without Python and download known NSNS HiPS surveys completely.',
  'Local Survey Server öffnen':'Open Local Survey Server',
  'Local Survey Server nicht erreichbar. Starte ANP-Local-Survey-Server-1.1.exe oder aktiviere den Autostart.':'Local Survey Server not reachable. Start ANP-Local-Survey-Server-1.1.exe or enable autostart.',
