/* Astro Night Planner 1.0 – Testversion 19 mit Standortkorrektur, Aladin-Popup-Fixes und Umrisszeichnung */
'use strict';
...
function renderFilters(){
  ...
  return `<details ${profile.central.collapsed.filters?'':'open'} id="filterDetails">
    ...
    <div class="filter-tab-panel ${active==='basis'?'active':''}" data-filter-tab-panel="basis">
      ...
      <div class="filter-search-bottom-row"><label class="filter-search-field filter-area-search">Suche<input id="objectSearch" value="${esc(profile.planning.search)}" placeholder="M31, NGC, Rosette …"><span class="small muted">Automatische Aktualisierung nach 1,5 Sekunden; Enter sucht sofort.</span></label></div>
    </div>
...
window.addEventListener('message',event=>{
  ...
  if(event.data?.type==='anp-outline-saved'){
