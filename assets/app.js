/* Astro Night Planner 1.3.0-test.3 – Testversion */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'test', appVersion:'1.3.0-test.3', release:'1.3.0-test.3', databaseName:'astro-night-planner-test-v1', documentTitle:'Astro Night Planner 1.3.0-test.3'});
...
function bindCentralDraft(){
  ...
  const altAzColor=document.getElementById('externalAladinAltAzGridColor');if(altAzColor)altAzColor.onchange=()=>{draft.central.externalAladin=draft.central.externalAladin||{};draft.central.externalAladin.altAzGridColor=altAzColor.value;setSectionDirty('display')};
