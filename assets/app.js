/* Astro Night Planner 1.4.2 – Produktivversion */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'prod', appVersion:'1.4.2', release:'1.4.2', databaseName:'astro-night-planner-prod-v1', documentTitle:'Astro Night Planner 1.4.2'});
...
Object.assign(EN_EXACT,{
  ...
  'Der optionale Local Survey Server 1.1 kann lokale HiPS-Dateien ohne Python bereitstellen und alle in der App eingebauten sowie benutzerdefinierte kompatible HiPS-Surveys herunterladen.':'The optional Local Survey Server 1.1 can serve local HiPS files without Python and download all surveys built into the app as well as compatible custom HiPS surveys.',
...
function versionNotesHtml(lang=language){
  ...
  const preferred=['version142','version141','version140','version130','version120','version110'];
