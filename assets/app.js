/* Astro Night Planner 1.4.2-test.5 – Testversion */
'use strict';

const BUILD = Object.freeze(window.ANP_BUILD || {environment:'test', appVersion:'1.4.2-test.5', release:'1.4.2-test.5', databaseName:'astro-night-planner-test-v1', documentTitle:'Astro Night Planner 1.4.2-test.5'});
...
Object.assign(EN_EXACT,{
  ...
  'Der optionale Local Survey Server 1.1 (Build 1.1.4) kann lokale HiPS-Dateien ohne Python bereitstellen und alle in der App eingebauten sowie benutzerdefinierte kompatible HiPS-Surveys herunterladen.':'The optional Local Survey Server 1.1 (Build 1.1.4) can serve local HiPS files without Python and download all surveys built into the app as well as compatible custom HiPS surveys.',
