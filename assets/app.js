/* Astro Night Planner 1.0 – Testversion 16 mit Aladin-Survey-Konfiguration, Messlinie und Übersetzungs-/Umrisskorrekturen */
'use strict';
...
const CURATED_OBJECT_OUTLINES = {
  'NGC7000': {source:'Manuell kuratierter Planungsumriss aus öffentlich sichtbarer Himmelsbilddarstellung; grober visueller Umriss, keine wissenschaftliche Kontur.', polygons:[[
    [313.92,42.95],[314.05,43.45],[314.18,43.88],[314.32,44.22],[314.47,44.62],[314.68,44.98],[314.88,45.28],[315.10,45.55],[315.28,45.42],[315.48,45.22],[315.78,45.00],[316.08,44.76],[316.32,44.46],[316.46,44.14],[316.25,43.86],[315.96,43.58],[315.72,43.32],[315.55,43.02],[315.44,42.70],[315.20,42.83],[315.02,42.62],[314.78,42.38],[314.48,42.25],[314.18,42.42],[313.98,42.66]
  ]]},
...
function renderCentral(){
  ...
  <div class="card subtab-panel ${currentCentralSubTab==='display'?'active':''}">
    ...
    <div class="metric aladin-survey-settings" style="margin-top:12px"><div class="section-title-row"><div><strong>Aladin-Surveys</strong><div class="small muted">Weitere Surveys können manuell per HiPS-ID ergänzt werden. Monochrome Surveys werden in ihrer nativen Darstellung angezeigt und nicht künstlich eingefärbt.</div></div><button id="addAladinSurvey" type="button">Survey hinzufügen</button></div>
