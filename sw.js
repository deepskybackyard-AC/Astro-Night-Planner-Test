/* Astro Night Planner 1.4.1-test.1 - Test-Cache */
'use strict';
const ENV = 'test';
const VERSION = '1.4.1-test.1';
...
const CORE = [
  ...
  './assets/build-config.js', './assets/styles.css', './assets/app.js', './assets/catalog.generated.json', './assets/andreas-cordt-logo.png', './aladin-frame.html', './docs/ASTRO_NIGHT_PLANNER_HANDBUCH.html', './docs/ASTRO_NIGHT_PLANNER_HANDBUCH.pdf', './docs/ASTRO_NIGHT_PLANNER_HANDBUCH_DE.html', './docs/ASTRO_NIGHT_PLANNER_HANDBUCH_DE.pdf', './docs/ASTRO_NIGHT_PLANNER_HANDBUCH_EN.html', './docs/ASTRO_NIGHT_PLANNER_HANDBUCH_EN.pdf', './tools/ANP-Local-Survey-Server-1.0.zip', './tools/ANP-Local-Survey-Server-Linux-macOS-1.0.zip', './tools/ANP-Local-Survey-Server-Python-1.0.zip'
];
